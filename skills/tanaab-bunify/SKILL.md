...
2. Convert build and lint entry points to Bun.
...
4. Update action and release plumbing.
...
5. Replace npm-specific runtime commands in repo code and scripts.
...
- No bundled scripts. Apply this workflow directly against the target repository.
