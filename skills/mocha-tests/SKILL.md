...
1. Add one test file per utility module.
...
1. Follow naming and style conventions.
...
1. Add test scripts in package metadata.
...
1. Wire CI as a release/deploy gate (policy).
