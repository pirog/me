...
/** Compare one authoritative automation snapshot with an expected managed task. */
export function automationMatchesExpected(actualTask, expected) {
  return changedFields(comparableActual(actualTask), expected).length === 0;
}
